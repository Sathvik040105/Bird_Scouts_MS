...
from audio.data import species, num_species_classes, common_names, orders, num_order_classes, family, num_family_classes
...
def mtl_species_classi(file_path):
    ...
    state_dict = torch.load("./audio/best_species_model.weights_new.pth", map_location=device)
