...
dataset = {
    "train_data": "/home/xintrean/Back-up/notes/sem_5/Project_1/Trunk/trunk/train",
    "valid_data": "/home/xintrean/Back-up/notes/sem_5/Project_1/Trunk/trunk/val", 
...
for idx, split in enumerate(['train', 'val', 'test']):
    if idx < len(all_data):
        print(f"{split} set: {len(all_data[idx]['imgpath'])} images")
...
# model.classifier[1] = nn.Linear(num_ftrs, 29)
# model.to(device)
